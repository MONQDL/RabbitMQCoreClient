...
namespace RabbitMQCoreClient.Exceptions
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="ClientConfigurationException"></see> class.</summary>
        public ClientConfigurationException()
        {

        }

        /// <summary>Initializes a new instance of the <see cref="ClientConfigurationException"></see> class with serialized data.</summary>
        ...
        protected ClientConfigurationException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
