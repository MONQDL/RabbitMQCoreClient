...
public static class BatchQueueExtensions
{
    ...
    public static void AddEvent<T>(this IQueueBufferService service, [NotNull] T obj, string routingKey)
        where T : class =>
    ...
    /// <param name="routingKey">The name of the route key with which you want to send events to the data bus.</param>
    public static void AddEvent(this IQueueBufferService service, ReadOnlyMemory<byte> obj, string routingKey) =>
    ...
    /// <param name="obj">The byte array object to send to the data bus.</param>
    /// <param name="routingKey">The name of the route key with which you want to send events to the data bus.</param>
    public static void AddEvent(this IQueueBufferService service, byte[] obj, string routingKey) =>
        service.Add(new EventItem(obj, routingKey));
    ...
    /// <param name="routingKey">The name of the route key with which you want to send events to the data bus.</param>
    public static void AddEvent(this IQueueBufferService service, string obj, string routingKey) =>
    ...
    /// <returns></returns>
    [RequiresUnreferencedCode("Serialization might require types that cannot be statically analyzed.")]
    public static void AddEvents<T>(this IQueueBufferService service, IEnumerable<T> objs, string routingKey)
        where T : class
    {
    ...
    /// <param name="routingKey">The name of the route key with which you want to send events to the data bus.</param>
    /// <returns></returns>
    public static void AddEvents(this IQueueBufferService service, IEnumerable<ReadOnlyMemory<byte>> objs, string routingKey)
    {
        foreach (var obj in objs)
            service.Add(new EventItem(obj, routingKey));
    }
    ...
    /// <param name="routingKey">The name of the route key with which you want to send events to the data bus.</param>
    /// <returns></returns>
    public static void AddEvents(this IQueueBufferService service, IEnumerable<byte[]> objs, string routingKey)
    {
        foreach (var obj in objs)
            service.Add(new EventItem(obj, routingKey));
    }
    ...
    /// <param name="routingKey">The name of the route key with which you want to send events to the data bus.</param>
    /// <returns></returns>
    public static void AddEvents(this IQueueBufferService service, IEnumerable<string> objs, string routingKey)
    {
        foreach (var obj in objs)
            service.Add(new EventItem(Encoding.UTF8.GetBytes(obj).AsMemory(), routingKey));
    }
