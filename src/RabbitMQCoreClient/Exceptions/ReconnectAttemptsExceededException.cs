...
/// <summary>
/// Create new object of <see cref="ReconnectAttemptsExceededException"/>.
/// </summary>
public class ReconnectAttemptsExceededException : Exception
{
    ...
    public ReconnectAttemptsExceededException(string message, Exception innerException) : base(message, innerException)
    {
